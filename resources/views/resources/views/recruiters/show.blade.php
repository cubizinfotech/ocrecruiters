            ...
            <div class="max-w-7xl mx-auto px-4 -mt-16 relative z-10">
                <div class="bg-white shadow-md rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        class="w-20 h-20 rounded-full object-cover shadow" alt="Logo">
                    ...
                    <div class="flex items-center gap-3" x-data="{ fileOpen: false, aboutOpen: false, showContact: false }">
                        ...
                        <div x-show="fileOpen"
                            ...
                            <div @click.away="fileOpen = false"
                                class="bg-white rounded-xl shadow-2xl w-full max-w-3xl p-6 relative transform transition-all">
                                ...
                                <div class="overflow-y-auto max-h-[80vh]">
                                    ...
                                    @else
                                        <p class="text-gray-600">
                                            ...
                                            {{-- <a href="{{ asset('storage/' . $recruiter->resume->file_path) }}" 
                                            target="_blank" 
                        ...
                        <div x-show="aboutOpen"
                            ...
                            <div @click.away="aboutOpen = false"
                                ...
                                <!-- Render summary as formatted HTML safely -->
                        ...
                        <div class="relative" @mouseenter="showContact = true" @mouseleave="showContact = false">
                            ...
                            <!-- Tooltip -->
                            <div x-show="showContact" x-cloak style="width: max-content;"
